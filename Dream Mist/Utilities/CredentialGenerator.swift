...
enum CredentialGenerator {
    ...
    nonisolated static let challengeChartable = Array("ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890")

    // Returns a random server challenge string for the GameSpy auth handshake.
    nonisolated static func generateChallenge(length: Int) -> String {
    ...
    nonisolated static func generateAuthToken(length: Int) -> String {
